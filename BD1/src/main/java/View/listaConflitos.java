    ...
    public listaConflitos()  {
        ...
        setLocationRelativeTo(null);
            ...
            try {
                ...
                String sql = "insert into 'ConflitosBelicos'.'Conflitos' (id,nome,num_mortos) values(2,'Curdo-Turco',234); ";
            ...
            Logger.getLogger(listaConflitos.class.getName()).log(Level.SERVERE, null, ex);
        }
    }
